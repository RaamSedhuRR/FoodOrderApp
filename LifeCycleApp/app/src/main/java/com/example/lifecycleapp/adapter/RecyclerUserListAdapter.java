...
public class RecyclerUserListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    Context context;

    List<User> userList;
    public RecyclerUserListAdapter(Context context, List<User> userList){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position){
        ...
        (( RecyclerUserListViewHolder ) holder).bindView(userList.get(position).getId(),userList.get(position).getName(),
